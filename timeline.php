...
if($_SERVER['REQUEST_METHOD']=='POST'){
	$indicators=$_POST['formDoor1'];
	$countries=$_POST['formDoor'];
	$years=$_POST['myyears'];
	Auth::instance()->_create_data_barchart3($countries,$indicators,$years);

	//create report
	$date = date_create();
	$file = 'multitimeline.tsv';
	$newfile = "reports/test".date_timestamp_get($date).".txt";//date('m/d/Y', 1299446702);
	Auth::instance()->_insert_new_report($_SESSION['user_id'],date_timestamp_get($date),$newfile,'timeline');
	...
	header('Location: multitimeline.php'); 
}
...
<html>
	...
	<div class="row" id="features">
		...
		<div class="col-sm-8 feature"><!--second col-->
			<div class="panel">
				<div class="panel-heading">
					<h3 class="panel-title">Δείκτης</h3>	
				</div><!--end panel-heading-->
  				<div class="form-group">
    					<?php
						include_once 'Auth.php';
						...
						while ($row = $results->fetch_row()){
							...
							echo '<input type="checkbox" name="formDoor1[]" value="'.$row[0].'"> '.$row[1].'<br />';
		...
		<div class="col-sm-2 feature"><!--third col-->
			<div class="panel">
				<div class="panel-heading">
