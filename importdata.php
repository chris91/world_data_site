...
if($_SERVER['REQUEST_METHOD']=='POST'){
	...
	$_SESSION['indicator_id']=$indicator;
	$data=Auth::instance()->_take_the_data($country,$indicator,$year);
	$_SESSION['country']=$data[0];
	$_SESSION['indicator']=$data[1];
	$_SESSION['year']=$year;
	$_SESSION['data']=$data[2];
	$_SESSION['isnull']=$data[3];
